...
describe("post-fix wiring verification for 066/067/069/070/071", () => {
  ...
  it("keeps treatment/provenance persistence side-specific at coverage output", () => {
    ...
    expect(repo).toContain('p1_treatment: metricResultsTable.p1_treatment, p2_treatment: metricResultsTable.p2_treatment,');
    ...
    expect(repo).toContain('target: [metricCoverageRatesTable.metric_code, metricCoverageRatesTable.player_side, metricCoverageRatesTable.audit_run_id]');
  });
});
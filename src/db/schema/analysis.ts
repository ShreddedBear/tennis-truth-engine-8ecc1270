...
export const stressResultsTable = pgTable("stress_results", {
  ...
  p1_support_percent_after: numeric("p1_support_percent_after"),
  p2_support_percent_before: numeric("p2_support_percent_before"),
  p2_support_percent_after: numeric("p2_support_percent_after"),

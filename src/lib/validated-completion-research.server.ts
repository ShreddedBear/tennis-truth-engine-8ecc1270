...
const COMPOSITE_COMPONENTS:Record<string,Array<{name:string;terms:string[]}>>={
  ...
  "036":[
    ...
    {name:"loss serve deterioration",terms:["loss serve deterioration","serve decline"]},
    {name:"loss return deterioration",terms:["loss return deterioration","return decline"]},

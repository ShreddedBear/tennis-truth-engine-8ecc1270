...
["004","Required derived metrics added to the metrics workflow","Elo/form/serve/return/MC inputs needed by each defined derived comparison","META_DERIVED"],
["005","Interpretation rules","reliability, sample, independence, surface relevance and metric magnitudes","META_DERIVED"],
["006","Recalibration rule","recent results, opponent quality, surface/form history and current calibration sample","RECONSTRUCTABLE"],
...
["027","Opponent Finishing Ability","set/break lead histories and serving-for-match outcomes","RECONSTRUCTABLE"],
...
["038","Opponent-Adjusted Residual Performance","serve/return/points/games/sets against opponent norms","SOURCE_REQUIRED"],
["039","Performance Surprise Rating","pre-match expectation plus actual underlying match performance","RECONSTRUCTABLE"],
["040","Hidden Decline Detector","rolling serve/return/ace/DF/break/duration trends","SOURCE_REQUIRED"],
...
["048","Independent-Evidence Count","persisted independent evidence families and correlation map","META_DERIVED"],

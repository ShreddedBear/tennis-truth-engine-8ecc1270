...
const FORBIDDEN: Array<[RegExp, string]> = [
  ...
  [/predictionEngine(?:\/|['"])/,                 "runtime path containing predictionEngine"],
  [/from\s+['"].*\/evaluation(?:\/|['"])/,       "import from Prediction/Evaluation runtime"],
  [/require\(['"].*\/evaluation(?:\/|['"])/,     "require() from Prediction/Evaluation runtime"],
  [/\bgetActiveCalibration\s*\(/,                "borrowed Prediction calibration cache"],
  [/\bapplyCalibrationOriented\s*\(/,            "borrowed Prediction calibration function"],
  [/\bcomputeSurfaceEloModule\s*\(/,             "borrowed Prediction surface Elo module"],
  [/\bcomputeServeReturnModule\s*\(/,            "borrowed Prediction serve/return module"],

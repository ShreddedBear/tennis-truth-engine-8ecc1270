...
ROOT=Path('data/audit/bsd-atp-challenger-pbp-history')
...
def aggregate():
    ...
    progress={
        ...
        'total_atp_challenger_matches_examined':sum(int(r.get('atp_challenger_matches',0)) for r in rows),

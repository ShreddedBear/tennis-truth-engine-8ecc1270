...
- **PARTIAL, verified via a dedicated per-metric audit (either workstream):** 46 metrics (001, 002, 003, 004, 005, 006, 007, 008, 009, 010, 011, 012, 013, 014, 015, 016, 018, 020, 021, 023, 024, 025, 027, 028, 029, 030, 031, 032, 033, 035, 036, 037, 039, 041, 042, 046, 051, 053, 055, 060, 064, 068, 071, 075, 077, 080) — 018 is flagged as possibly over-claimed (RECONSTRUCTED, not PARTIAL, with a real definitional gap) and 020 as evidence-basis-uncertain (see their table rows and `docs/metric-audit-batch-005-016-018-020-032-068.md`), so treat those two as needing a follow-up pass before relying on their exact treatment value
...
| 018 | Momentum & Closing Metrics | RECONSTRUCTED (flagged, possibly over-claimed) | pbp-score-state-recovery.ts covers Closing Ability well; Performance Following Momentum Events only partially (breakback only, not the tiebreak-momentum half of its own definition); Opponent Comeback Susceptibility not covered at all. Same house-rule concern already fixed for 001/014/015 -- flagged as the next concrete follow-up, not changed this pass. See docs/metric-audit-batch-005-016-018-020-032-068.md. | 1.234568 pp max |
...
| 020 | Level/Tour Transition | PARTIAL (thin, granularity concern) | same_level_matches/win_pct measures aggregate performance at a level, not performance specifically at the transition between levels as the real definition asks -- a plausible instance of the same wrong-granularity pattern as 021/060/071 (item 4). Not fixed this pass. | 1.234568 pp max, evidence-basis uncertain |

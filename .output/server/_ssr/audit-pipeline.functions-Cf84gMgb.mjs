...
//#region node_modules/.nitro/vite/services/ssr/assets/audit-pipeline.functions-Cf84gMgb.js
...
}).handler(createSsrRpc("4ac1941ab3557ba306ca902e2bfcfb57bd1f3047e44521e86af2d674e716cf45"));
...
var runAuditBatch = createServerFn({ method: "POST" }).inputValidator((data) => data).handler(createSsrRpc("3d40c218fbacab19778ea8b58d7abfcdcb3d70e497136a0667d21247dbc1bbe1"));
//#endregion
export { driveAuditBatch, runAuditBatch };
